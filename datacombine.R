path <- "E:\\javacode\\trafficFlowData\\data\\train"
folder <- dir(path)
#print(length(folder))
#print(folder)
files <- list()
...
#print(temp)
write.csv(temp, file = "E:\\javacode\\BpNeuralNetwork-digtal_lable\\sample-data\\train.csv", row.names = FALSE,col.names = NULL,quote = FALSE)